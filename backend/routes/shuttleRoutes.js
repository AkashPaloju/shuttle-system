...
router.get("/", authMiddleware, adminMiddleware, shuttleControllers.getAllShuttles);
router.post("/", authMiddleware, adminMiddleware, shuttleControllers.createShuttle);
router.get("/:id", authMiddleware, adminMiddleware, shuttleControllers.getShuttleById);
